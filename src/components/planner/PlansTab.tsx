...
import { Plus, LayoutGrid, List, CalendarDays, Sparkles } from 'lucide-react';
...
export function PlansTab() {
  ...
  const { plans, loading, fetchPlans } = useVenueEventPlans();
    ...
    <div className="space-y-5">
      ...
      {filteredPlans.length === 0 ? (
        <div className="text-center py-20">
          ...
          <h3 className="text-base font-medium text-foreground">No plans yet</h3>
          ...
          {filteredPlans.map((plan, i) => {
            ...
            return (
              <motion.div
                ...
                className="flex items-center justify-between p-4 rounded-lg border border-border/50 bg-card/60 hover:bg-card hover:border-border cursor-pointer transition-colors"
              >
